 ...
 * @package Paytm Gateway For WooCommerce
 * @subpackage Paytm Gateway For WooCommerce/core
 * @since 1.0
 */
...
class Wc_Paytm_Gateway {
    ...
    private function define_constant(){
        $this->define('WC_PAYTMG_NAME', 'Paytm Gateway For WooCommerce'); # Plugin Name
